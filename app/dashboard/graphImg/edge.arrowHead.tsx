...
//   constructor(gl) {
//     super(gl);
//     // const program = createEdgeArrowHeadProgram(gl);
//     // console.log('qqq', program);

//     // Locations
//     this.positionLocation = gl.getProgram(this.program, 'a_position');
...
export default function createCustomEdgeProgram(gl) {
  const program = createEdgeArrowHeadProgram(gl);

  // Attach custom shaders
  program.vertexShaderSource = vertexShaderSource;
  program.fragmentShaderSource = fragmentShaderSource;
